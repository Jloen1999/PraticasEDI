...
public class LigaFutbol {
    ...
    public static int buscarEquipo(String msj) {
        ...
        if (!encontrado) {
            Vista.error("es.unex.cum.edi.ejerciciosRepaso.Capítulo6.Equipo no encontrado.");
    ...
    public static void borrarEquipo() {
        ...
        if (posicion != -1) {
            ...
            try {
                ...
                raf.seek((posicion - 1) * Equipo.TAM_REGISTRO);
                // Cargamos el equipo en una variable de tipo es.unex.cum.edi.ejerciciosRepaso.Capítulo6.Equipo
                eq.loadFromFile(raf);
