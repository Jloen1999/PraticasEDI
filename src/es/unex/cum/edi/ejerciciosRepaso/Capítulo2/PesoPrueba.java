package es.unex.cum.edi.ejerciciosRepaso.Capítulo2;

class PesoPrueba
{
   public static void main(String[] args)
   {
      Peso p1 = new Peso(10, "oz");    // Instancia objeto peso con valor 10 onzas
      Peso p2 = new Peso(10, "lb");    // Instancia objeto peso con valor 10 libras
      Peso p3 = new Peso(10, "kg");    // Instancia objeto peso con valor 10 kilogramos
      Peso p4 = new Peso(10, "gr");    // Instancia objeto peso con valor 10 gramos
